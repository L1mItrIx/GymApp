...
export const STATUS_STYLES: Record<VolumeStatus, { bg: string; text: string; ring: string; label: string }> = {
  low:      { bg: "bg-red-500/10",    text: "text-red-400",    ring: "ring-red-500/30",    label: "Muy pocas series" },
  mev:      { bg: "bg-amber-500/10",  text: "text-amber-400",  ring: "ring-amber-500/30",  label: "Por debajo del óptimo" },
  optimal:  { bg: "bg-emerald-500/10", text: "text-emerald-400", ring: "ring-emerald-500/30", label: "Óptimo" },
  high:     { bg: "bg-orange-500/10", text: "text-orange-400", ring: "ring-orange-500/30", label: "Volumen alto" },
  overload: { bg: "bg-red-600/15",    text: "text-red-400",    ring: "ring-red-600/40",    label: "Sobrecarga" },
};
