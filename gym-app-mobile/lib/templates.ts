...
export const TEMPLATES: PlanTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Pecho+Espalda, Hombros+Brazos y Pierna repetidos. Frecuencia 2 con sesiones largas, estilo culturismo clásico.",
    daysPerWeek: 6,
    days: [
      {
        dayOfWeek: 0,
        isRest: false,
        name: "Pecho + Espalda",
        focus: ["chest", "back", "lats", "rear_delts"],
        exercises: [
          { exerciseId: "bench-press", sets: 4, reps: "6-8", rir: 2 },
          { exerciseId: "incline-bench-db", sets: 3, reps: "8-10", rir: 2 },
          { exerciseId: "pec-deck", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "pullup", sets: 4, reps: "6-10", rir: 2 },
          { exerciseId: "barbell-row", sets: 3, reps: "8-10", rir: 2 },
          { exerciseId: "straight-arm-pulldown", sets: 3, reps: "10-12", rir: 1 },
        ],
      },
      {
        dayOfWeek: 1,
        isRest: false,
        name: "Hombros + Brazos",
        focus: ["front_delts", "side_delts", "rear_delts", "biceps", "triceps"],
        exercises: [
          { exerciseId: "overhead-press", sets: 4, reps: "6-8", rir: 2 },
          { exerciseId: "lateral-raise-db", sets: 4, reps: "12-15", rir: 1 },
          { exerciseId: "rear-delt-fly-machine", sets: 3, reps: "12-15", rir: 1 },
          { exerciseId: "barbell-curl", sets: 3, reps: "8-10", rir: 1 },
          { exerciseId: "preacher-curl-machine", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "skullcrusher", sets: 3, reps: "8-10", rir: 1 },
          { exerciseId: "tricep-pushdown", sets: 3, reps: "10-12", rir: 1 },
        ],
      },
      {
        ...
        focus: ["quads", "hamstrings", "glutes", "calves"],
        exercises: [
          { exerciseId: "back-squat", sets: 4, reps: "6-8", rir: 2 },
          { exerciseId: "leg-press", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "romanian-deadlift", sets: 3, reps: "8-10", rir: 2 },
          { exerciseId: "leg-curl-lying", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "leg-extension", sets: 3, reps: "12-15", rir: 1 },
      ...
      },
      {
        ...
        focus: ["chest", "back", "lats", "rear_delts"],
        exercises: [
          { exerciseId: "incline-bench-db", sets: 4, reps: "8-10", rir: 2 },
          { exerciseId: "chest-press-machine", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "cable-crossover", sets: 3, reps: "12-15", rir: 1 },
          { exerciseId: "lat-pulldown", sets: 4, reps: "8-10", rir: 2 },
          { exerciseId: "cable-row", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "face-pull", sets: 3, reps: "12-15", rir: 1 },
        ],
      },
      {
        ...
        focus: ["front_delts", "side_delts", "rear_delts", "biceps", "triceps"],
        exercises: [
          { exerciseId: "shoulder-press-machine", sets: 4, reps: "8-10", rir: 2 },
          { exerciseId: "lateral-raise-cable", sets: 4, reps: "12-15", rir: 1 },
          { exerciseId: "reverse-pec-deck", sets: 3, reps: "12-15", rir: 1 },
          { exerciseId: "db-curl", sets: 3, reps: "8-10", rir: 1 },
          { exerciseId: "hammer-curl", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "overhead-tricep-cable", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "tricep-rope", sets: 3, reps: "12-15", rir: 1 },
        ],
      },
      {
        dayOfWeek: 5,
        ...
        focus: ["quads", "hamstrings", "glutes", "calves"],
        exercises: [
          { exerciseId: "hack-squat", sets: 4, reps: "8-10", rir: 2 },
          { exerciseId: "leg-extension", sets: 3, reps: "12-15", rir: 1 },
          { exerciseId: "leg-curl-seated", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "hip-thrust-machine", sets: 3, reps: "10-12", rir: 1 },
          { exerciseId: "seated-calf-raise", sets: 4, reps: "10-12", rir: 1 },
